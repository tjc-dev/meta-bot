...
func (inst *PlaceOrder) SetArgs(args PlaceOrderArgs) *PlaceOrder {
	inst.Args = &args
	return inst
}
...
func (inst *PlaceOrder) SetOpenOrdersAdminAccount(openOrdersAdmin ag_solanago.PublicKey) *PlaceOrder {
...
func (inst *PlaceOrder) GetOpenOrdersAdminAccount() *ag_solanago.AccountMeta {
...
func (inst *PlaceOrder) SetOracleAAccount(oracleA ag_solanago.PublicKey) *PlaceOrder {
	inst.AccountMetaSlice[9] = ag_solanago.Meta(oracleA)
	return inst
}

// GetOracleAAccount gets the "oracleA" account.
func (inst *PlaceOrder) GetOracleAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetOracleBAccount sets the "oracleB" account.
func (inst *PlaceOrder) SetOracleBAccount(oracleB ag_solanago.PublicKey) *PlaceOrder {
	inst.AccountMetaSlice[10] = ag_solanago.Meta(oracleB)
	return inst
}

// GetOracleBAccount gets the "oracleB" account.
func (inst *PlaceOrder) GetOracleBAccount() *ag_solanago.AccountMeta {
...
func NewPlaceOrderInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *PlaceOrder {
