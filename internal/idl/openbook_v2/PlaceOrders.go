...
func (inst *PlaceOrders) SetOrdersType(ordersType PlaceOrderType) *PlaceOrders {
	inst.OrdersType = &ordersType
	return inst
}

// SetBids sets the "bids" parameter.
func (inst *PlaceOrders) SetBids(bids []PlaceMultipleOrdersArgs) *PlaceOrders {
	inst.Bids = &bids
	return inst
}

// SetAsks sets the "asks" parameter.
func (inst *PlaceOrders) SetAsks(asks []PlaceMultipleOrdersArgs) *PlaceOrders {
	inst.Asks = &asks
	return inst
}

// SetLimit sets the "limit" parameter.
func (inst *PlaceOrders) SetLimit(limit uint8) *PlaceOrders {
	inst.Limit = &limit
	return inst
}

// SetSignerAccount sets the "signer" account.
func (inst *PlaceOrders) SetSignerAccount(signer ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(signer).SIGNER()
	return inst
}

// GetSignerAccount gets the "signer" account.
func (inst *PlaceOrders) GetSignerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetOpenOrdersAccountAccount sets the "openOrdersAccount" account.
func (inst *PlaceOrders) SetOpenOrdersAccountAccount(openOrdersAccount ag_solanago.PublicKey) *PlaceOrders {
...
func (inst *PlaceOrders) GetOpenOrdersAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetOpenOrdersAdminAccount sets the "openOrdersAdmin" account.
func (inst *PlaceOrders) SetOpenOrdersAdminAccount(openOrdersAdmin ag_solanago.PublicKey) *PlaceOrders {
...
func (inst *PlaceOrders) GetOpenOrdersAdminAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetUserQuoteAccountAccount sets the "userQuoteAccount" account.
func (inst *PlaceOrders) SetUserQuoteAccountAccount(userQuoteAccount ag_solanago.PublicKey) *PlaceOrders {
...
func (inst *PlaceOrders) GetUserQuoteAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetUserBaseAccountAccount sets the "userBaseAccount" account.
func (inst *PlaceOrders) SetUserBaseAccountAccount(userBaseAccount ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(userBaseAccount).WRITE()
	return inst
}

// GetUserBaseAccountAccount gets the "userBaseAccount" account.
func (inst *PlaceOrders) GetUserBaseAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetMarketAccount sets the "market" account.
func (inst *PlaceOrders) SetMarketAccount(market ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(market).WRITE()
	return inst
}

// GetMarketAccount gets the "market" account.
func (inst *PlaceOrders) GetMarketAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetBidsAccount sets the "bids" account.
func (inst *PlaceOrders) SetBidsAccount(bids ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[6] = ag_solanago.Meta(bids).WRITE()
	return inst
}

// GetBidsAccount gets the "bids" account.
func (inst *PlaceOrders) GetBidsAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetAsksAccount sets the "asks" account.
func (inst *PlaceOrders) SetAsksAccount(asks ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(asks).WRITE()
	return inst
}

// GetAsksAccount gets the "asks" account.
func (inst *PlaceOrders) GetAsksAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

// SetEventHeapAccount sets the "eventHeap" account.
func (inst *PlaceOrders) SetEventHeapAccount(eventHeap ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[8] = ag_solanago.Meta(eventHeap).WRITE()
	return inst
}

// GetEventHeapAccount gets the "eventHeap" account.
func (inst *PlaceOrders) GetEventHeapAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(8)
}

// SetMarketQuoteVaultAccount sets the "marketQuoteVault" account.
func (inst *PlaceOrders) SetMarketQuoteVaultAccount(marketQuoteVault ag_solanago.PublicKey) *PlaceOrders {
...
func (inst *PlaceOrders) GetMarketQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(9)
}

// SetMarketBaseVaultAccount sets the "marketBaseVault" account.
func (inst *PlaceOrders) SetMarketBaseVaultAccount(marketBaseVault ag_solanago.PublicKey) *PlaceOrders {
...
func (inst *PlaceOrders) GetMarketBaseVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(10)
}

// SetOracleAAccount sets the "oracleA" account.
func (inst *PlaceOrders) SetOracleAAccount(oracleA ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[11] = ag_solanago.Meta(oracleA)
	return inst
}

// GetOracleAAccount gets the "oracleA" account.
func (inst *PlaceOrders) GetOracleAAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(11)
}

// SetOracleBAccount sets the "oracleB" account.
func (inst *PlaceOrders) SetOracleBAccount(oracleB ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(oracleB)
	return inst
}

// GetOracleBAccount gets the "oracleB" account.
func (inst *PlaceOrders) GetOracleBAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(12)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *PlaceOrders) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *PlaceOrders {
	inst.AccountMetaSlice[13] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *PlaceOrders) GetTokenProgramAccount() *ag_solanago.AccountMeta {
...
func NewPlaceOrdersInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *PlaceOrders {
