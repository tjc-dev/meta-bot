...
// NewRefillInstructionBuilder creates a new `Refill` instruction builder.
func NewRefillInstructionBuilder() *Refill {
	nd := &Refill{
...
func (inst *Refill) SetBaseAmount(baseAmount uint64) *Refill {
	inst.BaseAmount = &baseAmount
	return inst
}

// SetQuoteAmount sets the "quoteAmount" parameter.
func (inst *Refill) SetQuoteAmount(quoteAmount uint64) *Refill {
	inst.QuoteAmount = &quoteAmount
	return inst
}

// SetOwnerAccount sets the "owner" account.
func (inst *Refill) SetOwnerAccount(owner ag_solanago.PublicKey) *Refill {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *Refill) GetOwnerAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetUserBaseAccountAccount sets the "userBaseAccount" account.
func (inst *Refill) SetUserBaseAccountAccount(userBaseAccount ag_solanago.PublicKey) *Refill {
	inst.AccountMetaSlice[1] = ag_solanago.Meta(userBaseAccount).WRITE()
	return inst
}

// GetUserBaseAccountAccount gets the "userBaseAccount" account.
func (inst *Refill) GetUserBaseAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(1)
}

// SetUserQuoteAccountAccount sets the "userQuoteAccount" account.
func (inst *Refill) SetUserQuoteAccountAccount(userQuoteAccount ag_solanago.PublicKey) *Refill {
...
func (inst *Refill) GetUserQuoteAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(2)
}

// SetOpenOrdersAccountAccount sets the "openOrdersAccount" account.
func (inst *Refill) SetOpenOrdersAccountAccount(openOrdersAccount ag_solanago.PublicKey) *Refill {
...
func (inst *Refill) GetOpenOrdersAccountAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(3)
}

// SetMarketAccount sets the "market" account.
func (inst *Refill) SetMarketAccount(market ag_solanago.PublicKey) *Refill {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(market).WRITE()
	return inst
}

// GetMarketAccount gets the "market" account.
func (inst *Refill) GetMarketAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(4)
}

// SetMarketBaseVaultAccount sets the "marketBaseVault" account.
func (inst *Refill) SetMarketBaseVaultAccount(marketBaseVault ag_solanago.PublicKey) *Refill {
	inst.AccountMetaSlice[5] = ag_solanago.Meta(marketBaseVault).WRITE()
	return inst
}

// GetMarketBaseVaultAccount gets the "marketBaseVault" account.
func (inst *Refill) GetMarketBaseVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(5)
}

// SetMarketQuoteVaultAccount sets the "marketQuoteVault" account.
func (inst *Refill) SetMarketQuoteVaultAccount(marketQuoteVault ag_solanago.PublicKey) *Refill {
...
func (inst *Refill) GetMarketQuoteVaultAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(6)
}

// SetTokenProgramAccount sets the "tokenProgram" account.
func (inst *Refill) SetTokenProgramAccount(tokenProgram ag_solanago.PublicKey) *Refill {
	inst.AccountMetaSlice[7] = ag_solanago.Meta(tokenProgram)
	return inst
}

// GetTokenProgramAccount gets the "tokenProgram" account.
func (inst *Refill) GetTokenProgramAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(7)
}

func (inst Refill) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_Refill,
	}}
}
...
func (inst Refill) ValidateAndBuild() (*Instruction, error) {
...
func (inst *Refill) Validate() error {
...
func (inst *Refill) EncodeToTree(parent ag_treeout.Branches) {
	parent.Child(ag_format.Program(ProgramName, ProgramID)).
		//
		ParentFunc(func(programBranch ag_treeout.Branches) {
			programBranch.Child(ag_format.Instruction("Refill")).
				//
...
func (obj Refill) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *Refill) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
// NewRefillInstruction declares a new Refill instruction with the provided parameters and accounts.
func NewRefillInstruction(
	...
	tokenProgram ag_solanago.PublicKey) *Refill {
	return NewRefillInstructionBuilder().
