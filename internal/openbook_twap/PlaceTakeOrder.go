...
// PlaceTakeOrder is the `placeTakeOrder` instruction.
...
func (inst *PlaceTakeOrder) SetTwapMarketAccount(twapMarket ag_solanago.PublicKey) *PlaceTakeOrder {
	inst.AccountMetaSlice[0] = ag_solanago.Meta(twapMarket).WRITE()
	return inst
}

// GetTwapMarketAccount gets the "twapMarket" account.
func (inst *PlaceTakeOrder) GetTwapMarketAccount() *ag_solanago.AccountMeta {
...
func (inst *PlaceTakeOrder) SetOpenbookProgramAccount(openbookProgram ag_solanago.PublicKey) *PlaceTakeOrder {
	inst.AccountMetaSlice[12] = ag_solanago.Meta(openbookProgram)
	return inst
}

// GetOpenbookProgramAccount gets the "openbookProgram" account.
func (inst *PlaceTakeOrder) GetOpenbookProgramAccount() *ag_solanago.AccountMeta {
			...
			programBranch.Child(ag_format.Instruction("PlaceTakeOrder")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=14]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						accountsBranch.Child(ag_format.Meta("      twapMarket", inst.AccountMetaSlice.Get(0)))
...
func NewPlaceTakeOrderInstruction(
	...
	systemProgram ag_solanago.PublicKey) *PlaceTakeOrder {
